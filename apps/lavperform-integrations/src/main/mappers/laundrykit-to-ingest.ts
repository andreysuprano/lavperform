import type { IngestOrderDto } from './ingest-order.types'
...
function resolveOrderType(sourceType?: string): IngestOrderDto['orderType'] {
...
export function isLaundryKitOperationEligible(operation: LaundryKitOperation): boolean {
